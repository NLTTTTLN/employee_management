document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('confirmAddBtn').onclick = function() {
        ...
        const salary = document.getElementById		document.addEventListener('DOMContentLoaded', function() {
		    const sidebar = document.querySelector('.sidebar');
		    const toggleButton = document.querySelector('.toggle-btn');
		    const modal = document.getElementById('actionModal');
		    const addModal = document.getElementById('addModal');
		    ...
		    function deleteUser(username) {
		        if (confirm(`Are you sure you want to delete user ${username}?`)) {
		            ...
		            .then(() => {
		                ...
		                fetchEmployee(); // Refresh the employee table
		            })
		            .catch(error => console.error('Error deleting user:', error));
		        }
		    }

		    // Event for Confirm Action Button (Delete only)
